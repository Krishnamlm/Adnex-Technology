    ...
    >
      ...
      className="pb-6 text-sm text-gray-500 flex justify-center sm:justify-between gap-4 flex-wrap">
        ...
        <div className="flex items-center justify-between gap-4">
           {/* Facebook Link */}
    <a href="https://www.instagram.com/adnexindia/" target="_blank" rel="noopener noreferrer">
      <img src={assets.facebook_icon} alt="Facebook" />
    </a>
    
    {/* Twitter Link */}
    <a href="https://www.linkedin.com/company/adnex-technologies" target="_blank" rel="noopener noreferrer">
